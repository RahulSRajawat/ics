                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="tab">
                            ...
                            <button class="tablinks" onclick="lists(event, 'special_recharge')">Special Recharge</button>
                        ...
                        <div class="table-responsive">
                                <table width="100%" class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="re_td_data">NA</td>
                                        <td class="re_td_data">
                                            <button class="btn btn-outline-info" style="padding: 3px 13px;">Rs. 23</button>
                                        </td>
                                        <td class="re_td_data">Unlimited voice calls+U</td>
                                    </tr>
                                </table>
                        ...
                        <div class="table-responsive">
                                <table width="100%" class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="re_td_data">NA</td>
                                        <td class="re_td_data">
                                            <button class="btn btn-outline-info" style="padding: 3px 13px;">Rs. 65</button>
                                        </td>
                                        <td class="re_td_data">Unlimited voice calls+U</td>
                                    </tr>
                                </table>
                        ...
                        <div class="table-responsive">
                                <table width="100%" class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="re_td_data">NA</td>
                                        <td class="re_td_data">
                                            <button class="btn btn-outline-info" style="padding: 3px 13px;">Rs. 69</button>
                                        </td>
                                        <td class="re_td_data">Unlimited voice calls+U</td>
                                    </tr>
                                </table>
                        ...
                        <div class="table-responsive">
                                <table width="100%" class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="re_td_data">NA</td>
                                        <td class="re_td_data">
                                            <button class="btn btn-outline-info" style="padding: 3px 13px;">Rs. 95</button>
                                        </td>
                                        <td class="re_td_data">Unlimited voice calls+U</td>
                                    </tr>
                                </table>
