                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="lname" placeholder="Number" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Customer Email Id: *</label>
                                                <input type="text" class="form-control" name="phno" placeholder="Email Id" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phno" placeholder="Pincode" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">State: *</label>
                                                <input type="text" class="form-control" name="phno" placeholder="State" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">District: *</label>
                                                <input type="text" class="form-control" name="phno" placeholder="District" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label" for="pwd">Customer Marital Status:</label>
                                                <select class="form-select mb-3 shadow-none">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phno" placeholder="DOB" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="phno" placeholder="Children" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phno" placeholder="Duration" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Agent Referal Id: *</label>
                                                <input type="text" class="form-control" name="phno" placeholder="Id" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <fieldset>
                                <div class="form-card text-start">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Office Name/Company Name/Shop Name : *</label>
                                                <input type="text" class="form-control" name="fname" placeholder="Name" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="lname" placeholder="Address" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phno_2" placeholder="State" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phno" placeholder="Email" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Experience in Currect Company: *</label>
                                                <input type="number" class="form-control" name="phno" placeholder="Experience in Year" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Total work Experience: *</label>
                                                <input type="number" class="form-control" name="phno" placeholder="Total work Experience in Year" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" name="pic-3" accept="image/*">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Salary Slip (1st) Month:</label>
                                                <input type="file" class="form-control" name="pic-4" accept="image/*">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Salary Slip (2nd) Month:</label>
                                                <input type="file" class="form-control" name="pic-5" accept="image/*">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Salary Slip (3rd) Month:</label>
                                                <input type="file" class="form-control" name="pic-6" accept="image/*">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Bank Statement:</label>
                                                <input type="file" class="form-control" name="pic-7" accept="image/*">
                                            </div>
                                        </div>
                                    </div>
                                    <button type="button" name="next" class="btn btn-primary next action-button float-end" value="Submit">Submit</button>
